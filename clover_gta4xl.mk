#
# Copyright (C) 2025 The Clover Project
#
...
$(call inherit-product, vendor/clover/config/common_full_tablet.mk)

## Device identifier, this must come after all inclusions
PRODUCT_DEVICE := gta4xl
PRODUCT_NAME := clover_gta4xl
